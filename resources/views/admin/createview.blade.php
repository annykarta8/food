        ...
        <div style="position:relative;top:60px;right:-150px">
            <div>
                <form action="{{ url('/uploadfood') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <label>Price:</label>
                        <input class="text-black my-4" type="num" name="price" placeholder="price" required>
                    </div>
                    <div>
                        <label>Image:</label>
                    ...
                    <div>
                        ...
                        <input class="text-black my-4 " type="text" name="description" placeholder="Description"
                            required>
                    </div>
                    <div>
